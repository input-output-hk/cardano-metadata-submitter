...
bench_name=cardano-metadata-submitter-bench
total_time=total-time.txt

echo "--- Build"
# TODO: remove sourcesOverride
nix-build -A benchmarks.cardano-metadata-submitter.cardano-metadata-submitter-bench
bench=./result/bin/cardano-metadata-submitter-bench
